const WhatsAppButton = () => {
  const phoneNumber = "919727727599";
  ...
  return (
    <a
      ...
      aria-label="Chat with Heerency on WhatsApp"
      className="fixed bottom-4 right-4 z-50 rounded-full bg-green-500 p-3.5 text-white shadow-lg transition hover:bg-green-600 sm:bottom-5 sm:right-5 md:bottom-6 md:right-6"
    >
      <svg
