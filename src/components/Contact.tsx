    ...
    >
      <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
        <div className="text-center lg:text-left">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-1">
            <div className="rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] p-5">
              ...
              <p className="mt-2 text-[var(--color-text-soft)]">Usually within 24 hours</p>
            </div>
            <div className="rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] p-5">
              <p className="text-sm uppercase tracking-[0.2em] text-primary">
                Project Support
            ...
            <div className="mt-4 space-y-4">
              {projectSteps.map((step, index) => (
                <div key={step} className="flex items-start gap-4">
                  ...
                  <p className="pt-1 text-sm leading-6 text-[var(--color-text-soft)] sm:text-base">
                    {step}
                  </p>
                </div>
              ))}
        ...
        <form
          ...
          className="space-y-4 rounded-3xl border border-[var(--color-border)] bg-[var(--color-surface-strong)] p-5 text-left shadow-[0_30px_100px_var(--color-shadow)] sm:p-6 md:p-8"
        >
          <div className="pb-2">
            <h3 className="text-xl font-semibold text-[var(--color-text)]">Book a Design Consultation</h3>
          ...
          <input
            ...
            className="w-full rounded-xl border border-[var(--color-border)] bg-[var(--color-bg)] px-4 py-3 text-[var(--color-text)] placeholder:text-[var(--color-text-muted)]"
          />
          ...
          <textarea
            ...
            className="min-h-[140px] w-full rounded-xl border border-[var(--color-border)] bg-[var(--color-bg)] px-4 py-3 text-[var(--color-text)] placeholder:text-[var(--color-text-muted)]"
          />
